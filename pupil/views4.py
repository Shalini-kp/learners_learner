...
from pupil.models import User_info,Questions4,User_data,FeedBack,SessionData
...
def test13(request):
	...
	if (i<=10) :
		...
		return HttpResponseRedirect('/pupil/result41')
...
def test14(request):
	...
	if (i<=20) :
		...
		return HttpResponseRedirect('/pupil/result42')
...
def test15(request):
	...
	if (i<=num) :
		...
		return HttpResponseRedirect('/pupil/result43')
...
def result41(request):
	...
	cursor2=conn.execute("select rans from pupil_questions4 where set_id='1';")
	j=0
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status410')
	else:
		return HttpResponseRedirect('/pupil/status411')
...
def result42(request):
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status420')
	else:
		return HttpResponseRedirect('/pupil/status421')
...
def result43(request):
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status430')
	else:
		return HttpResponseRedirect('/pupil/status431')
...
def status410(request):
	...
	conn.commit();
	conn.close();
	return render_to_response('pupil/status410.html', context_dict, context)

def status411(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status411.html', context_dict, context)

def status420(request):
	context = RequestContext(request)
	context_dict = {'result': "Congradulations.You are qualified for the next level.",'qualified':qualified}
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	conn.execute("delete from pupil_user_data;")
	conn.commit();
	conn.close();
	return render_to_response('pupil/status420.html', context_dict, context)

def status421(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status421.html', context_dict, context)

def status430(request):
	context = RequestContext(request)
	context_dict = {'result': "Congradulations.You are qualified for the next level.",'qualified':qualified}
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	conn.execute("delete from pupil_user_data;")
	conn.commit();
	conn.close();
	return render_to_response('pupil/status430.html', context_dict, context)

def status431(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status431.html', context_dict, context)
